...
AS $$
DECLARE
  project_url TEXT := 'https://fcyvurqmcrnrvtylwvgg.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZjeXZ1cnFtY3JucnZ0eWx3dmdnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxOTI5OTI3NywiZXhwIjoyMDM0ODc1Mjc3fQ.zfbG2BxfhWvt6uZgNFBFj3BK5RJuIizmtsgoOWhI5Rw'; -- full access needed for http request to storage
